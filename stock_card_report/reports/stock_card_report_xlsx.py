...
class ReportStockCardReportXlsx(models.AbstractModel):
    ...
    def _get_ws_params(self, wb, data, product):
        filter_template = {
            "1_date_from": {
                "header": {"value": self.env._("Date From")},
                "data": {
            ...
            "2_date_to": {
                "header": {"value": self.env._("Date To")},
                "data": {
            ...
            "3_location": {
                "header": {"value": self.env._("Location")},
                "data": {
        ...
        stock_card_template = {
            ...
            "3_input": {
                "header": {"value": self.env._("In")},
                "data": {"value": self._render("input")},
                "width": 25,
            },
            "4_output": {
                "header": {"value": self.env._("Out")},
                "data": {"value": self._render("output")},
                "width": 25,
            },
            "5_balance": {
                "header": {"value": self.env._("Balance")},
        ...
        ws_params = {
            ...
            "title": f"{self.env._('Stock Card -')} {product.name}",
